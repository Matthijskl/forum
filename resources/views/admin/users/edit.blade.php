        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('cp.users.update', ['id' => $user->id]) }}"
                          class="forms-sample" id="change_password_request">
                        {{ csrf_field() }}
                        ...
                        <button type="submit" class="btn btn-success mr-2"
                                id="button-password-change">{{ trans('admin.buttons.update') }}</button>
                    </form>
                </div>
            </div>
        </div>
